...
const CreateAccount: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // New users are sent to OTP verification after entering their phone number.
        navigate('/otp');
    };
    ...
    return (
        <div className="flex flex-col h-screen w-full max-w-md mx-auto bg-background-light dark:bg-background-dark p-6">
            ...
            <main className="flex-1 flex flex-col pt-8">
                <h1 className="text-3xl font-bold text-text-light dark:text-text-dark">Create Account</h1>
