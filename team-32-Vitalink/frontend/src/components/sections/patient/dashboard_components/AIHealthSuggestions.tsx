  ...
  const aiSuggestions = [
    {
      type: "hydration",
      title: "Stay Hydrated",
      description: "Based on your activity level, aim for 8-10 glasses of water today.",
      priority: "medium",
      icon: Droplets,
    },
    {
      ...
      description: "A 20-minute walk would be beneficial for your cardiovascular health.",
      priority: "high",
      icon: Activity,
    },
    {
